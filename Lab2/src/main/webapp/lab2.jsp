...
<body onload="chosenButton(document.getElementById('0'))">
<center>
    <div class="header_1">
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="add_arror" >
                                    ...
                                    <input class="input_R field" id="R" type="text" maxlength="8" name="R" placeholder="(1 .. 4)" value="2"><br>
                                </td>
                            </tr>
        ...
        <div class="newWindow">
            <table id="beanTable">
                ...
                <c:forEach items="${BeanPoints.list}" var="item">
                    <tr>
                        <script>document.getElementById("R").value =${item.r}</script>
                        <td> ${item.x} </td>
                        <td> ${item.y} </td>
                        <td> ${item.r} </td>
                        <c:choose>
    ...
    <script>drawCanvas('canvas',document.getElementById('R').value)</script>
    <c:forEach items="${BeanPoints.list}" var="item">
        <tr>
            <script>drawPoint(${item.x},${item.y},document.getElementById('R').value)</script>
        </tr>
    </c:forEach>
